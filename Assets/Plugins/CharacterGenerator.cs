...
public class CharacterGenerator
{
	...
	public static bool ReadyToUse 
	{
		get
		{
            ...
            //Debug.Log(sortedElements.Count);
            //foreach (KeyValuePair<string, Dictionary<string, List<CharacterElement>>> item in sortedElements)
            //{
            //    Debug.Log(item.Key + ":" + item.Value.Count);
            //    foreach (KeyValuePair<string, List<CharacterElement>> temp in item.Value)
            //    {
            //        Debug.Log(temp.Key + ":" + temp.Value.Count);
            //        foreach (CharacterElement t in temp.Value)
            //        {
            //            Debug.Log(t.name + ":" + t.bundleName);
            //        }
            //    }
            //}
